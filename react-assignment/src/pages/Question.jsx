...
const Question = (props) => {
    ...
    useEffect(() => {
        fetch('http://ec2-16-16-99-212.eu-north-1.compute.amazonaws.com:8000/api/question?game_id=' + sessionStorage.getItem("game_id") + '&api_key=' + sessionStorage.getItem("api_key"))
